	...
	<div id="page-wrapper" class="page-wrapper-cls">
		...
		<?php endif; ?>
			...
			<div class="adduserform-main upload-logo-panel company-panel">
				...
				{{ Form::model($record, array('action' => array('MemberController@memberEditPost', $record->hash), 'method' => 'post') ) }}
				...
				<div class="companySave">
					<input type="submit" value="Save & Go to Members List " name = "save_and_listing" class="next-company">
					<input type="submit" value="Save & Go to Member's Detail" name = "save_and_detail" class="save-views">
				</div>
